-- Remove the problematic line that requires superuser permissions
...
-- Enable Row Level Security (RLS is optional for now, can be enabled later)
...
-- Create RLS policies (commented out for now - can enable later)
